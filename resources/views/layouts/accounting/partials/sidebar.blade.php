<div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">TAD Accounting</a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown {{Request::is('*dashboard')?'active':''}} {{Request::is('*dashboard/finance')?'active':''}}">
                ...
                <ul class="dropdown-menu">
                 @if (Auth::user()->role_id == 1 ) <li class="{{Request::is('*dashboard')?'active':''}}"><a class="nav-link" href="{{ route('dashboard.index') }}">General Dashboard</a></li>@endif
