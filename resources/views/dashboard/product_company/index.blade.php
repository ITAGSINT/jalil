    ...
    <div class="col-12 grid-margin">
      <div class="card" >
        <div class="card-body">
          ...
          <br>
          <hr>
          <form action="{{ route('dashboard.product_company.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                                <div class="row">
                                    <div class="col-12  grid-margin">
            ...
            <div style="margin:2em 0">
              <button type="submit" class="btn btn-outline-warning btn-fw">{{ __('dashboard/categories.add') }}</button>
              <button type="button" class="btn btn-outline-warning btn-fw" id="exit-cat-btn">{{ __('dashboard/categories.cancel') }}</button>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="card">
          <div class="card-body">
              <div style="display: flex;justify-content: space-between;">
                  <h4 class="card-title mb-0" style=""> Companies</h4>
                  <div style="display: flex;justify-content: space-between;">

            <button type="button" class="btn btn-warning btn-fw "  id="add-cat-btn">Add Company </button>
          </div>
...
$('#cat').DataTable({
    ...
    ajax: "{{ route('dashboard.products_company.dataTable') }}",
