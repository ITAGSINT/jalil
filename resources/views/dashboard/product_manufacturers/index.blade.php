    ...
    <div class="col-12 grid-margin">
      <div class="card" >
        <div class="card-body">
          ...
          <br>
          <hr>
          <form action="{{ route('dashboard.product_manufacturers.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12  grid-margin">
  ...
  <div class="col-12 grid-margin">
      <div class="card">
          <div class="card-body">
            ...
            <button type="button" class="btn btn-warning btn-fw "  id="add-cat-btn">Add Manufacturer </button>
          </div>
...
$('#cat').DataTable({
    ...
    ajax: "{{ route('dashboard.product_manufacturers.dataTable') }}",
