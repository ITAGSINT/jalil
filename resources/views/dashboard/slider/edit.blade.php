                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dashboard.slider.update') }}" method="POST"
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <input class="form-control w-50" type="text" style="margin-bottom: 2em;"
                                        name="title" value="{{ is_null(old('title')) ? $slider->title : old('title') }}">
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3 imgUp">
                                        ...
                                        <label class="btn btn-primary">
                                            ...
                                            {{-- <!--<img style='width:100px;height:100px;border:solid green 1px;;margin:1px' src='{{ URL::asset(!is_null($slider->image) ? $slider->image->path() : 'prod.png') }}' />--> --}}
                            ...
                            <div style="margin:2em 0">
                                ...
                                <a class="btn btn-outline-warning btn-fw" href={{ route('dashboard.slider.index') }}
