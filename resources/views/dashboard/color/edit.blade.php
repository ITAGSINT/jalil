            ...
            <div class="col-12 grid-margin">
                <div class="card" style="background-color: white;">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('dashboard.color.update', $brand->id) }}" method="POST"
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control w-50" type="color" style="margin-bottom: 2em;"
                                        name="hex_code" value="{{ is_null(old('hex_code')) ? $brand->hex_code : old('hex_code') }}">
                                    @error('hex_code')
                            ...
                            <div style="margin:2em 0">
                                ...
                                <a class="btn btn-outline-warning btn-fw" href={{ route('dashboard.color.index') }}
