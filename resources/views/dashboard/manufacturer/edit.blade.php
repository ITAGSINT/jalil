            ...
            <div class="col-12 grid-margin">
                <div class="card" style="background-color: white;">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('dashboard.manufacturer.update', $brand->id) }}" method="POST"
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="car_yes">
                                            <input type="radio" class="form-radio" name="is_car" id="car_yes"
                                                value="1" @checked($brand->is_car == 1) required>
                                            Car</label>

                                    </div>
                                    <div class="form-group">
                                        <label for="car_no">
                                            <input type="radio" class="form-radio" name="is_car" id="car_no"
                                                value="2" @checked($brand->is_car == 2)>
                                            Motorcycle
                                        </label>
