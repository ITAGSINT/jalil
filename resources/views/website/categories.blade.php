    ...
    <script>
        ...
        function filter_and_sort_fun(type){
          ...
          var url = $(location).attr('href'),
           ...
           if(type=='this_page') window.location.href='/categories/all/all/'+last_part+'/'+minprice+','+maxprice;	
           if(type=='feature') window.location.href='/categories/feature/'+last_part+'/'+minprice+','+maxprice;	
            if(type=='newCollection') window.location.href='/categories/new-collection/'+last_part+'/'+minprice+','+maxprice;
           if(type=='height_low_price') window.location.href='/categories/height-low/'+last_part+'/'+minprice+','+maxprice;
            if(type=='low_height_price') window.location.href='/categories/low-height/'+last_part+'/'+minprice+','+maxprice;
        }
	</script>
<div >   
                <h5 style="padding-top: 25px; padding-left: 25px;" class="page_location"><a  href="/"> Home </a>><a href="/categories/all"> categories</a>>

                
                    @foreach($category_name as $category_name)	
                    <a href="/categories/{{$category_name->categories_id}}"> 
                    {{$category_name->description->first()->categories_name}}
                    </a>
                    @endforeach</h5>
</div>
...
<div class="container">   
    ...
    <div class="row  categories">
        ...
        @php
        $i=1;
       $s=count($category_products->products);
         @endphp  
        
        @foreach($category_products->products as $products)
...
<div class="container-fluid">   
   ...
   @endforeach 
    ...
    <div clas="row  categories res-categories" style="text-align:center; padding-top: 30px;">
