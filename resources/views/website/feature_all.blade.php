...
<div class="">   
    <h5 style="padding-top: 25px; padding-left: 25px;" class="page_location"><a  href="/"> Home </a>><a href="/categories/all"> Categories </a>><a href="/categories/feature"> Feature</a></h5>
</div>
    ...
    <div  class="stay" style="padding: 30px;color: #939393;">
          ...
          <div class="filter_div">
            <label class="container">Featured
              <input type="radio"  onclick="filter_and_sort_fun('feature')" name="radio" checked>
...
<desktop>
    ...
    <div class="container" id="product_container">      
        ...
        @foreach($category_name as $category_name)
         ...
         @php
                $cc=count($category_name->products_is_feature);
                 @endphp 
