...
<div class="">   
    <h5 style="padding-top: 25px; padding-left: 25px;" class="page_location"><a  href="/"> Home </a>><a href="/categories/all"> Categories </a>><a href=""> Price Low-High </a></h5>
</div>
          ...
          <div class="filter_div">
           ...
           <label class="container">Price High-Low
             ...
             <label class="container">Price Low-High
              <input type="radio" onclick="filter_and_sort_fun('low_height_price')" name="radio" checked>
              <span class="checkmark"></span>
            </label>
...
<desktop>
    ...
    <div class="container" id="product_container">      
        ...
        @if(in_array($category_name->categories_id, $filter_cat_array) )
                @php
                $cc=count($category_name->lowHeightProducts);
                 @endphp 
            <div class="row  categories " style="@if($cc==0) display:none @endif">
                ...
                @php
                $i=1;
                $s=count($category_name->lowHeightProducts);
                 @endphp 
                @foreach($category_name->lowHeightProducts as $products)
