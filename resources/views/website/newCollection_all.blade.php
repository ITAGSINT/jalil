...
<div class="">   
    <h5 style="padding-top: 25px; padding-left: 25px;" class="page_location"><a  href="/"> Home </a>><a href="/categories/all"> Categories </a>><a href=""> Newest </a></h5>
</div>
    ...
    <div  class="stay" style="padding: 30px;color: #939393;">
          ...
          <div class="filter_div">
            ...
            <label class="container">Newest
              <input type="radio"   onclick="filter_and_sort_fun('newCollection')" name="radio" checked>
              <span class="checkmark"></span>
            </label>
...
<desktop>
    ...
    <div class="container" id="product_container">      
        ...
        @foreach($category_name as $category_name)
         ...
         @php
                $cc=count($category_name->products_new_collection);
                 @endphp 
            <div class="row  categories " style="@if($cc==0) display:none @endif">
                ...
                @php
                $i=1;
                $s=count($category_name->products_new_collection);
                 @endphp 
                @foreach($category_name->products_new_collection as $products)
