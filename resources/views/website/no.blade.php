...
<div class="container ">
  <div class="row w-100 pt-5 ">
    <div class="col-lg-6 col-md-12 choose mx-auto mt-3">
      ...
      <div class="row w-100  align-content-center justify-content-center pb-4 h-90  user_vichles"  style=" overflow-y: scroll; max-height: 40rem;">
        <div class="col-6 ">
    ...
    <div class="col-lg-5 col-md-12 mx-auto mt-3" style="background-color: white; border-radius:2.25rem;  padding: 1.5rem;">
      <div class="row w-100 pt-4">
        <div class="col-12">
          <p class="right">Choose the right battery for you !(choose your ride first)</p>
        </div>
...
<div class="row w-100 d-flex align-items-end justify-content-end pt-5 ">
  <div class="col-4 greenbutton">
    <a class="btn next " href="{{route('website.change')}}" role="button">Next</a>
  </div>
</div> -->
...
<script>
    $(document).ready(function() { 
       ...
       $.ajax({
      url: '{{route('website.get.all.cars')}}', type: "get",
      data: {
        type: 1,
      },
      // processData: false,
  ...
  function handleClick(car_id) {
    ...
    $.get('{{ route("website.sub_category1")}}', { parent_id: 1,car_id: car_id}, function(response) {
          ...
          category.products.forEach(function(product) {
            productsHtml += `
                    <div class="form-check brand-radio my-3">
                        <input  onclick="handleClick12(`+product.product_id+`,`+product.products_price+`);" class="form-check-input check-location" type="radio" name="productRadioGroup${category.cat_id}" id="product${product.product_id}">
