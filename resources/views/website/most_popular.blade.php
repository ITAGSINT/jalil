    ...
    <script>
      ...
      /////////////////// add categoriers to munue and function to url///////////////////
        ...
        function filter_and_sort_fun(type){
           ...
           if(type=='this_page') window.location.href='?cat='+{{id}}+'&&price='+minprice+','+maxprice;	
                                ...
                                <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                                  <div class="accordion-body">
                                    <section class="range-slider ">
                                      ...
                                      <input name="rangeOne" value="20" min="0" max="{{$max_price}}" step="1" type="range" id="minprice">
    ...
    <div  class="stay" style="padding: 30px;color: #939393;">
          ...
          <div class="filter_div">
            <label class="container">Featured
              <input type="radio" checked="checked" onclick="filter_and_sort_fun('feature')" name="radio">
            ...
            <label class="container">Most Popular
...
<desktop>
@php
   if(!empty($_GET['cat']) && !empty($_GET['price'])){
@endphp

    <script>
        var cat= @php echo '['.$_GET['cat'].']'; @endphp;
    ...
    @php 
        ...
        foreach ($array as $element) {
    @endphp
          $.get('{{ route("filter_fun")}}',{cat:@php echo $element; @endphp ,price:price ,type:'feature'},function(data1){
            console.log(data1);
    	    var category="";
    	    var sub="";
    	    var c=1;
   ...
   @php 
     ...
     @endphp
         ...
         $.get('<?= route("website.categoriers_sub_menue")?>',function(data2){
                     ...
                     for (var i2 = 0; i2 < data2.length; i2++) {
                                    ...
                                    //alert ('['+cat_Arr+']');
                                       $.get('{{ route("filter_fun")}}',{cat: cat_Arr,price:price ,type:'feature'},function(data1){
    ...
    <div class="container" id="product_container">      
        ...
        @foreach($category_name as $category_name)
         ...
         @if($category_name->description)
          <div class="row  categories" style="    margin: 0px 0!important;">
    @foreach($category_name->description as $descriptiona)
         ...
         @endforeach
          @php
            $i=1;
           $s=count($category_name->products_is_feature);
             @endphp 
           @foreach($category_name->products_is_feature as $products)
            ...
            <div class="row" >
                ...
                <div class="col-10">
                    <a  href="{{asset('/product')}}">
                        <img src="{{asset('/assets/img/man1.png')}}">
                    </a>
                </div>
            </div>
        </div>
   ...
   <div class="row categories res-categories">
        <div class="col-12  sec-one" >
          ...
          <div class="row" >
              ...
              <div class="col-10">
              <a  href="{{asset('/product')}}">
                  <img src="{{asset('/assets/img/man2.png')}}">
                  </a>
              </div>
          </div>
